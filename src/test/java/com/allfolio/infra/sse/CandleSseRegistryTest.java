...
class CandleSseRegistryTest {
    ...
    void subscribeRecordsUserIdAndUnsubscribeClearsIt() {
        ...
        registry.subscribe(KEY, emitter, "user-1");
        assertThat(registry.userIdOf(emitter)).contains("user-1");

        registry.unsubscribe(KEY, emitter);
        assertThat(registry.userIdOf(emitter)).isEmpty();
    }
    ...
    void secondSubscriberJoinsSameKey() {
        ...
        registry.subscribe(KEY, second, "user-2");
    ...
    void differentIntervalsForSameTickerAreIndependentKeys() {
        ...
        registry.subscribe(dayKey, dayEmitter, "user-1");
        registry.subscribe(weekKey, weekEmitter, "user-2");
