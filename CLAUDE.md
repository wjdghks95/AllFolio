...
AllFolio는 **Phase 기반 점진적 개발**로 설계되었습니다. Phase 1(애플리케이션 골격 구축)·Phase 2(UI/UX 완성 + 백엔드 도메인 구현, 2026-08-27 완료)·Phase 3(실데이터 연동 + 외부 시세 API + Redis 캐시, 2026-09-06 완료)·Phase 4(종목 검색 기반 등록 + 미국 주식 시세, Task 027 완료로 2026-09-10 종료)까지 끝났고, 현재는 **Phase 5 (고급 기능 및 최적화)** 진행 전입니다 — 다음은 Task 028(SSE 실시간 시세 스트리밍 및 실시간 차트)입니다. 진행 상황은 [`docs/ROADMAP.md`](docs/ROADMAP.md) 「개발 단계」 절 참조.
